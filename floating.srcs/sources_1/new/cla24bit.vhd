...
architecture Behavioral of cla24bit is
    ...
    signal p_aux : STD_LOGIC_VECTOR(5 downto 0);
    signal g_aux : STD_LOGIC_VECTOR(5 downto 0);
...
begin
    ...
    p_aux(5) <= p(20) and p(21) and p(22) and p(23);                                              
    ...
    g_aux(5) <= g(23) or ( p(23) and g(22) ) or ( p(23) and p(22) and g(21) ) or ( p(23) and p(22) and p(21) and g(20) );        
    ...
    c(6) <= g_aux(5) or ( p_aux(5) and c(5) );                                  
